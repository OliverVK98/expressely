...
import { useGetCommentsAnalytics } from '../../model/api/analytics';
import {
    BarChartData,
    BarChartOptionsType,
    LineChartData,
...
export const CommentsAnalytics = memo((props: CommentsAnalyticsProps) => {
    const { className, currentYear, chartType, color } = props;
    const {
        data: chartData,
        error,
        isLoading,
    } = useGetCommentsAnalytics(currentYear);
